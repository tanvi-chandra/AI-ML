class Graph:
    def __init__(self, graph, heuristicNodeList, startNode): 
        #instantiate graph object with graph topology, heuristic values, start node
            #The self keyword in Python is used to all the instances in a class. 
            #By using the self keyword, one can easily access all the instances defined 
            #within a class, including its methods and attributes. 
            #init. __init__ is one of the reserved methods in Python. 
